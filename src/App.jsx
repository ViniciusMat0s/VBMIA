    ...
    <section id="top" className="theme-hero relative flex min-h-screen flex-col overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1360px] flex-1 flex-col px-4 pt-28 md:px-6 md:pt-32 lg:px-8 lg:pt-32">
        <div className="relative mx-auto flex w-full max-w-[1280px] flex-1 flex-col items-center justify-center pb-24 pt-8 md:pb-24 md:pt-12 lg:pb-28">
          ...
          >
            <FloatingPill label="Acceder a la biblioteca" href="/library" />
            <FloatingPill label="Ver contenidos" href="#courses" small />
          </div>
        </div>
      </div>
...
function FloatingPill({ label, small = false, href = "#" }) {
  const className = `hero-pill inline-flex cursor-pointer items-center rounded-full border border-slate-200 bg-white px-4 py-2 text-[#16233d] shadow-[0_10px_28px_rgba(18,32,58,0.12)] transition-all duration-300 ease-out hover:border-[#1f57ff] hover:bg-[#1f57ff] hover:text-white hover:shadow-[0_10px_28px_rgba(31,87,255,0.18)] ${
